...
INSERT INTO `categoria` VALUES (1,'Informática'),(2,'Escritório'),(3,'Casa, mesa e banho'),(4,'Eletrônicos'),(5,'Jardinagem'),(6,'Decoração'),(7,'Perfumaria');
...
INSERT INTO `cliente` VALUES (1,'36378912377','maria@hotmail.com','Maria Silva','$2a$10$nYIP3fJikkdgvBubEBZ07OAZkvqB3e33Ys1ATNcnxDKz1d12Q6x.m',1),(2,'05614431063','joao.pedro.luz@hotmail.com','João Pedro Luz','$2a$10$p7vXoFyVBbWAWJfyjrSFRe8t93PaXDodhEZypAyEXIP6V9fxkUQP2',1);
...
INSERT INTO `endereco` VALUES (1,'Jardim','38220834','Apto 303','Rua Flores','300',1,1),(2,'Centro','38777012','Sala 800','Avenida Matos','105',2,1),(3,'Centro','45005000',NULL,'Floriano','2060',2,2);
...
INSERT INTO `pagamento_com_boleto` VALUES (NULL,'2017-10-20 02:00:00.000000',2);
...
INSERT INTO `produto` VALUES (1,'Computador',2000),(2,'Impressora',800),(3,'Mouse',80),(4,'Mesa de Escritório',300),(5,'Toalha',50),(6,'Colcha',200),(7,'TV True Color',1200),(8,'Roçadeira',800),(9,'Abajur',100),(10,'Pendente',180),(11,'Shampoo',90);
...
INSERT INTO `produto_categoria` VALUES (1,1),(1,4),(2,1),(2,2),(2,4),(3,1),(3,2),(3,4),(5,3),(6,3),(7,4),(8,5),(9,6),(10,6),(11,7);
...
INSERT INTO `telefone` VALUES (1,'27363323'),(1,'93838393'),(1,'40028922');
...
-- Dump completed on 2022-03-02 20:00:04
